...
<template>
  ...
  <button
    class="back-to-top hidden items-center justify-center bg-primary text-white w-10 h-10 rounded-md fixed bottom-8 right-6 left-auto z-[999] hover:shadow-signUp hover:bg-opacity-80 shadow-md"
    @click="scrollToTop()"
  >
