...
const ticketsLink = computed(() => {
  if (locale.value === 'en') { return 'https://shop.ikbenaanwezig.nl/language/language_redirect/english?current_url=https%3A%2F%2Fshop.ikbenaanwezig.nl%2Fkiosk%2Fharmonics-trancedans' } else { return 'https://shop.ikbenaanwezig.nl/language/language_redirect/dutch?current_url=https%3A%2F%2Fshop.ikbenaanwezig.nl%2Fkiosk%2Fharmonics-trancedans' }
})
</script>
